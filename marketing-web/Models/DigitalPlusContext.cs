...
{
    public partial class DigitalPlusContext : DbContext
    {
        public DigitalPlusContext()
        {
        }

        public DigitalPlusContext(DbContextOptions<DigitalPlusContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=SQL5103.site4now.net;Initial Catalog=db_a7ac86_digitalplus;Connection Timeout=200;User ID=db_a7ac86_digitalplus_admin;Password=Drejtorat2019");
            }
        }
